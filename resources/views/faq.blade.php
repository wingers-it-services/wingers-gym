    ...
    ********-->
    ...
    <div class="col-12">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-header" id="cardHeader12">
                            <h5 class="card-title">How can User Delete Account</h5><i class="fa fa-plus" aria-hidden="true"></i>
                        </div>
                        <div class="card-body" id="cardBody12" style="display: none;">
                            <p class="card-text">
                                Delete Account:
                            <ol>
                                <li>1. Navigate to profile.</li>
                                <li>2. In account section click on delete account</li>
                                <li>3. Confirm </li>
                            </ol>
                            </p>
                        </div>
    ...
    <script>
        ...
        document.getElementById('cardHeader11').addEventListener('click', function() {
         ...
         document.getElementById('cardHeader12').addEventListener('click', function() {
            toggleCardBody('cardBody12');
        });
    </script>
