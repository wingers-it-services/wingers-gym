...
***********************************-->
				...
				<nav class="navbar navbar-expand">
					<div class="collapse navbar-collapse justify-content-between">
						<div class="header-left">
							<!-- <div class="dashboard_bar">{{ Auth::guard('gym')->user()->gym_name }}</div> -->
						</div>
						...
						<ul class="navbar-nav header-right">
							...
							<li class="nav-item dropdown header-profile">
								<a class="nav-link" href="#" role="button" data-bs-toggle="dropdown">
									<img id="user-image" src="{{ Auth::guard('gym')->user()->image }}" width="20"
										alt="">
								</a>
								<div class="dropdown-menu dropdown-menu-end">
									...
									<a href="/gym-logout" class="dropdown-item ai-icon">
				...
				<ul class="metismenu" id="menu">
					<li><a class="has-arrow ai-icon" href="javascript:void(0)" aria-expanded="false">
						...
						<ul aria-expanded="false">
							...
							<li><a href="/ai-dashboard">AI Dashboard<span
					...
					<li><a class="has-arrow ai-icon" href="/gym-customers" aria-expanded="false">
						...
						<ul aria-expanded="false">
							...
							<li><a href="/customers-payment">User Payment History</a></li>
						</ul>
					</li>
					<li>
						<a href="/gym-schedule">
    ...
    ***********************************-->
	...
	<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.min.css"
		integrity="sha512-vKMx8UnXk60zUwyUnUPM3HbQo8QfmNx7+ltw8Pm5zLusl1XIfwcxo8DbWCqMGKadNxWA8yrx5v3SaVpMvR3CA=="
		crossorigin="anonymous" referrerpolicy="no-referrer" />
	<!-- Required vendors -->

	<script src="https://fito.dexignzone.com/laravel/demo/vendor/datatables/js/jquery.dataTables.min.js"
		type="text/javascript"></script>
	<script src="https://fito.dexignzone.com/laravel/demo/js/plugins-init/datatables.init.js"
		type="text/javascript"></script>

	<!-- calander -->
	<script src="https://fito.dexignzone.com/laravel/demo/vendor/moment/moment.min.js" type="text/javascript"></script>
	<script src="https://fito.dexignzone.com/laravel/demo/vendor/fullcalendar/js/main.min.js"
		type="text/javascript"></script>
	<script src="https://fito.dexignzone.com/laravel/demo/js/plugins-init/fullcalendar-init.js"
		type="text/javascript"></script>
