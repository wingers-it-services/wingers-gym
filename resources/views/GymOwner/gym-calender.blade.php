...
@section('content')
                                ...
                                <div id="external-events" class="my-3">
                                    ...
                                    @foreach ($gymShedule as $schedule)
                                        <div class="external-event btn-primary light" data-class="bg-primary"
                                            ...
                                            <i class="fas fa-edit" onclick="openUpdateModal({{ $schedule->id }})"></i>
                                ...
                                <form method="post" class="needs-validation" action="{{ route('addGymShedule') }}"
                                    ...
                                    <div class="row" style="padding-top: 5%;">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control form-white" placeholder="Enter end time"
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-danger light waves-effect"
                                            data-bs-dismiss="modal">Close</button>
                                        <button type="submit"
                                            class="btn btn-primary waves-effect waves-light save-category">Save</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                                ...
                                <form method="POST" class="needs-validation" action="/updateGymShedule"
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <label class="control-label">Event Name</label>
                                            <input class="form-control form-white" placeholder="Enter event name"
                                                type="text" name="event_name" id="update_event_name" required>
                                            <div class="invalid-feedback">
                                                Event Name is required.
                                            </div>
                                        </div>
                                    ...
                                    <div class="row" style="padding-top: 5%;">
                                        <div class="col-md-6">
                                            <label class="control-label">Recurring</label>
                                            <select class="form-control form-white" data-placeholder="Choose..."
                                                name="is_recurring" id="update_is_recurring" required>
                                                <option value="" disabled selected>Choose...</option>
                                                <option value="0">No</option>
                                                <option value="1">Yes</option>
                                            </select>
                                    ...
                                    <div class="row" style="padding-top: 5%;">
                                        <div class="col-md-6">
                                            <label class="control-label">Start Time</label>
                                            <input class="form-control form-white" placeholder="Enter start time"
                                                type="time" name="start_time" id="update_start_time" required>
                                            <div class="invalid-feedback">
                                                Start Time is required.
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="control-label">End Time</label>
                                            <input class="form-control form-white" placeholder="Enter end time"
                                                type="time" name="end_time" id="update_end_time" required>
                                            <div class="invalid-feedback">
                                                End Time is required.
                                            </div>
                                        </div>
                                    ...
                                    <div class="row" style="padding-top: 5%;">
                                        <div class="col-md-12">
                                            <label class="control-label">Description</label>
                                            <textarea class="form-control" id="update_description" name="description" rows="4"
                                                placeholder="Enter description here..." required></textarea>
                                            <div class="invalid-feedback">
                                                Description is required.
                                            </div>
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-danger light waves-effect"
                                            data-bs-dismiss="modal">Close</button>
                                        <button type="submit"
                                            class="btn btn-primary waves-effect waves-light save-category">Update</button>
                                    </div>
                                </form>
                            </div>
                        </div>
    ...
    <script>
        ...
        function openUpdateModal(eventId) {
            // Perform an AJAX request to fetch event data based on eventId
            $.ajax({
