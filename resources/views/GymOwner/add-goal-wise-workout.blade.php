                                    ...
                                    <table id="example3" class="table table-bordered table-striped verticle-middle table-responsive-sm">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <!-- <td class="text-end">
                                                    <span>
                                                        <a href="javascript:void(0);" class="me-4 edit-goal-button" data-bs-toggle="modal" data-bs-target="#editGoal" data-goal='@json($goalWiseWorkout)'>
                                                            <i class="fa fa-pencil color-muted"></i>
                                                        </a>
                                                        <a onclick="confirmDelete('{{ $goalWiseWorkout->uuid }}')" data-bs-toggle="tooltip" data-placement="top" title="Close">
