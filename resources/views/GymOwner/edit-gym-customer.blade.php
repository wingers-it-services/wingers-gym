								...
								<div class="col-lg-6 order-lg-1">
									<div class="col-xl-12 col-lg-12">
										...
										<ul class="list-group mb-3">
											<div class="col-md-12 mb-3">
												<select class="me-sm-2 form-control default-select" id="subscription_id" name="subscription_id">
													...
													<option value="{{ $subscription->id }}"
														...
														{{ $subscription->id == $selectedSubscriptionId ? 'selected' : '' }}>
											...
											<div class="col-md-12 mb-3">
												<label for="joining_date">Member Joining Date</label>
												<input type="date" class="form-control" id="joining_date" name="joining_date" value="{{ $userDetail->joining_date }}" required>
											</div>
