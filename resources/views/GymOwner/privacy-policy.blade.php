 ...
 <head>
     ...
     <meta name="description" content="Privacy Policy for Wingers IT Services PVT. LTD.">
     ...
     <!-- Stylesheets -->
     <link href="https://fito.dexignzone.com/laravel/demo/vendor/bootstrap-select/dist/css/bootstrap-select.min.css" rel="stylesheet" type="text/css" />
 ...
 <body>
     ...
     <div class="container">
         ...
         <h2>How to delete user Account</h2>
         <p>
            Delete Account:
             1. Navigate to profile.
             2. In account section click on delete account.
             3. Confirm
         </p>
         ...
         <ul>
             ...
             <li><strong>Application</strong> refers to Wits Gym, the software program provided by the Company.</li>
             <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Wingers IT Services PVT. LTD, T-4, ATC (Asian Trade Center) plot no-320/3, Near Asian Paint Chokdi, GIDC Ankleshwar, Gujarat 393002.</li>
         ...
         <ul>
             <li>By visiting this page on our website: <a href="https://demo.wingersitservices.co.in/" rel="external nofollow noopener" target="_blank">https://demo.wingersitservices.co.in/</a></li>
         </ul>
     </div>
