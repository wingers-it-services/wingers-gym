                ...
                <div class="card h-auto">
                    <div class="card-body">
                        ...
                        <div class="profile-blog mb-5 text-center">
                            ...
                            <img src="{{ $gym->qrcode }}" alt=""
                                class="img-fluid mt-4 mb-4 w-80 d-block mx-auto">
                        </div>
                                            ...
                                            <div class="settings-form">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <div
                                                            class="d-flex justify-content-between align-items-center mb-3">
                                                            <h4 class="text-primary mb-0">Add No. Of Days To Notify
                                                                User Before
                                                        ...
                                                        <div class="row">
                                                            <div
                                                                ...
                                                                <h4 class="text-primary">List of Holidays</h5>
                                                                    ...
                                                                    <form
                                                                        action="{{ route('runHolidayNotificationCronJob') }}"
                                                                        method="get">
                                                                        <button class="btn btn-primary btn-sm"
                                                                            data-toggle="modal">
                                                                            Notify user for holiday
                                                                        </button>
                                                                    </form>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="modal fade" id="addHolidayModal" tabindex="-1"
                                                    role="dialog" aria-labelledby="addHolidayModalLabel"
                                                    aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                    ...
                                    <div id="account-settings" class="tab-pane fade">
                                        ...
                                        <form id="updateProfile" action="/update-gym-account" method="POST"
                                                ...
                                                <div class="card-body text-center">
                                                    ...
                                                    <div class="profile-image-wrapper mb-3">
                                                        ...
                                                        <img id="profileImagePreview"
                                                            src="{{ asset($gym->image) }}" alt="Profile Image"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" name="username"
                                                        value="{{ $gym->username }}" class="form-control" required>
                                                    <div class="invalid-feedback">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" id="phone_no" name="phone_no"
                                                        placeholder="Phone" value="{{ $gym->phone_no }}"
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <select name="gym_type" class="form-control" required>
                                                        ...
                                                        <option value="Male"
                                                            {{ $gym->gym_type == 'Male' ? 'selected' : '' }}>Male
                                                        </option>
                                                        <option value="Female"
                                                            {{ $gym->gym_type == 'Female' ? 'selected' : '' }}>Female
                                                        </option>
                                                        <option value="Unisex"
                                                            {{ $gym->gym_type == 'Unisex' ? 'selected' : '' }}>Unisex
                                                        </option>
                                                    </select>
                                                    <div class="invalid-feedback">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="file" class="form-control"
                                                        id="owner_identity_document" name="owner_identity_document"
                                                        accept=".pdf, .jpg, .jpeg"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="address" placeholder="Apartment, studio, or floor" class="form-control" required>{{ $gym->address }}</textarea>
                                                <div class="invalid-feedback">
