                        ...
                        <div class="list-group list-group-flush">
                            @foreach ($gymUsers as $gymUser)
                                <a href="javascript:void(0);"
                                    ...
                                    id="staff-cards" data-gym-id='{{ $gymUser->gym_id }}' data-user-id='{{ $gymUser->id }}'
...
<script>
    const AttendenceStatusEnum = {
        PRESENT: {{ \App\Enums\AttendenceStatusEnum::PRESENT }},
        ABSENT: {{ \App\Enums\AttendenceStatusEnum::ABSENT }},
        WEEKEND: {{ \App\Enums\AttendenceStatusEnum::WEEKEND }},
        HOLIDAY: {{ \App\Enums\AttendenceStatusEnum::HOLIDAY }}
    };
    ...
    function openAttendanceMenu(dayElement, day) {
        ...
        <button class="dropdown-item" onclick="markDayAttendance(${day}, AttendenceStatusEnum.PRESENT, {{ $gymUser->gym_id ?? '' }} , $userId)">Present</button>
        <button class="dropdown-item" style="background-color: indianred;" onmouseover="this.style.backgroundColor='#b22222'" onmouseout="this.style.backgroundColor='indianred'" onclick="markDayAttendance(${day}, AttendenceStatusEnum.ABSENT, {{ $gymUser->gym_id ?? '' }}, $userId)">Absent</button>
