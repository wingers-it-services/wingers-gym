...
<div class="content-body ">
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-xl-4 col-lg-4 col-md-12" style="height: 100vh; overflow-y: auto;">
					...
					<div class="card-body p-0">
						<div class="list-group list-group-flush">
							...
							<a href="javascript:void(0);" class="list-group-item list-group-item-action d-flex align-items-center"
								...
								data-employee-name='{{$gymStaff->name}}'
								...
								<img src="{{ $gymStaff->image }}" alt="" class="rounded-circle me-3" style="height: 50px; width: 50px; object-fit: cover;">
								<div>
			...
			<div class="col-xl-8 col-lg-8 col-md-12" id="employee-details-section">
