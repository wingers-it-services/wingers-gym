                        ...
                        <div class="card">
                            <div class="card-header d-sm-flex d-block pb-0 border-0">
                                <div class="me-auto pe-3">
                                    ...
                                    <p class="fs-13 mb-0 text-black">Manage your gym's subscription plans here.</p>
                                </div>
                                    ...
                                    <table class="table table-bordered table-striped verticle-middle table-responsive-sm">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-end">
                                                    <span>
                                                        <a href="javascript:void(0)" class="me-4 btn-edit"
                                                           data-uuid="{{ $subscription->uuid }}"
                                                           data-name="{{ $subscription->subscription_name }}"
                                                        ...
                                                        <a href="javascript:void(0)" class="btn-delete" data-uuid="{{ $subscription->uuid }}" data-bs-toggle="tooltip" data-placement="top" title="Delete">
                                                            <i class="fa fa-trash" aria-hidden="true"></i>
                                                        </a>
                                                        <form id="delete-form-{{ $subscription->uuid }}" action="{{ route('deleteGymSubscription', $subscription->uuid) }}" method="POST" style="display: none;">
                                                            @csrf
                                                            @method('DELETE')
                                                        </form>
                                                    </span>
