                                ...
                                <div class="tab-pane fade show active" id="Breakfast" role="tabpanel">
                                    <div class="featured-menus owl-carousel">
                                        <div class="items">
                                            <div class="d-sm-flex p-3 border border-light rounded">
                                                <a href="ecom-product-detail.html"><img class="me-4 food-image rounded"
                                                        src="public/images/menus/3.png" alt=""
                                                        width="160"></a>
                                                <div>
                                                    <div class="d-flex align-items-center mb-2">
                                                        <img class="rounded-circle me-2 profile-image"
                                                            src="public/images/testimonial/3.jpg" alt=""
                                                            width="30">
                                        ...
                                        <div class="items">
                                            <div class="d-sm-flex p-3 border border-light rounded">
                                                <a href="ecom-product-detail.html"><img class="me-4 food-image rounded"
                                                        src="public/images/menus/1.png" alt=""
                                                        width="160"></a>
                                                <div>
                                                    <div class="d-flex align-items-center mb-2">
                                                        <img class="rounded-circle me-2 profile-image"
                                                            src="public/images/testimonial/1.jpg" alt=""
                                                            width="30">
                                        ...
                                        <div class="items">
                                            <div class="d-sm-flex p-3 border border-light rounded">
                                                <a href="ecom-product-detail.html"><img class="me-4 food-image rounded"
                                                        src="public/images/menus/2.png" alt=""
                                                        width="160"></a>
                                                <div>
                                                    <div class="d-flex align-items-center mb-2">
                                                        <img class="rounded-circle me-2 profile-image"
                                                            src="public/images/testimonial/2.jpg" alt=""
                                                            width="30">
