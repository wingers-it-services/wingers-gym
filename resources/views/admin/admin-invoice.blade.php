                    ...
                    <div class="row align-items-center">
                        <div class="col-sm-9">
                            <div class="brand-logo mb-3">
                                <img class="logo-abbr me-2" src="https://fito.dexignzone.com/laravel/demo/images/logo.png" alt="">
                                <span><strong class="d-block">WITS GYM</strong>
                            </div>
                        ...
                        <div class="col-sm-3 mt-3"> <img src="https://fito.dexignzone.com/laravel/demo/images/qr.png" class="img-fluid width110" alt=""></div>
                    </div>
                </div>
            </div>
